...
echo gettype($salary_min) . ": " . $salary_min . " " .  gettype($salary_max) . ": " . $salary_max . PHP_EOL;
...
// // ユーザーを生成
$restrauntChains = Helpers\RandomGenerator::restaurantChains($location, $employee, $salary_min, $salary_max, $postcode_min, $postcode_max);
foreach ($restrauntChains as $restrauntChain) {
    $restrauntChain->toHTML();
}
